  ...
  return (
    <div className="flex w-full max-w-[559px] flex-col gap-6 text-white md:gap-8">
      <h1 className="max-w-[547px] text-[28px] font-bold leading-[1.18] tracking-[-0.2px] md:text-[48px] md:leading-[56px] md:tracking-[-0.5px]">
        <span className="text-brand-sky">{hero.headline.leadingAccent}</span>
        <br />
      ...
      <div className="flex w-full max-w-[559px] items-stretch gap-3">
        <span
          aria-hidden="true"
          className="mt-[2px] h-[43px] w-[3px] shrink-0 rounded-[20px] bg-brand-sky shadow-[0_0_6px_0_rgba(41,215,227,0.37)]"
        />
      ...
      >
        <span className="flex h-12 min-w-[136px] items-center justify-center rounded-full bg-white px-6 text-base font-medium text-brand-navy md:w-[174px]">
          <span className="md:hidden">{hero.cta.mobile.label}</span>
          <span className="hidden md:inline">{hero.cta.desktop.label}</span>
        </span>
        <span
          aria-hidden="true"
          className="flex size-12 items-center justify-center rounded-full bg-brand-sky text-white transition-transform group-hover:rotate-12"
        >
