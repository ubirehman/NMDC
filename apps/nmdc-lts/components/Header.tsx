      ...
      <div className="relative w-full max-w-[320px] md:max-w-[1240px]">
        <div className="flex h-[62px] items-center justify-between rounded-full border border-white/20 bg-[rgba(69,79,80,0.82)] px-4 shadow-[0_24px_70px_rgba(0,0,0,0.30)] backdrop-blur-[18px] md:h-[72px] md:bg-[rgba(22,38,43,0.86)] md:px-[30px]">
          <button
            ...
            className="flex size-9 items-center justify-center rounded-full text-white transition-colors hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lts-tan md:hidden [@media_(pointer:coarse)_and_(min-width:768px)_and_(max-width:1199px)]:flex"
          >
        ...
        <nav
          ...
          className={`fixed inset-y-0 left-0 z-40 flex w-[84vw] max-w-[340px] flex-col overflow-hidden bg-[rgba(6,42,54,0.96)] px-5 py-6 shadow-2xl backdrop-blur-[18px] transition-[transform,visibility] duration-300 ease-out md:hidden [@media_(pointer:coarse)_and_(min-width:768px)_and_(max-width:1199px)]:flex ${
